 ...
 * @summary Gerencia as interações de suporte, como o formulário de contato.
*/
class SupportController {
    
    /**
     * @method sendContactMessage
     * @summary Valida e envia uma mensagem de contato para o e-mail de suporte.
     * @description Recebe os dados do formulário, verifica se o remetente é um usuário
     * registrado, e formata um e-mail em HTML com todas as informações para a equipe de suporte.
    */
    static async sendContactMessage(req, res, next) {
        try {
            ...
            if (!name || !email || !message) {
                throw new MissingValues({ name, email, message });
            }
